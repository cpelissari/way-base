...
public class AgendamentoDeTatu extends AgendamentoAbstrato<Tatu> {
  ...
  public AgendamentoDeTatu(Identificador<Tatu> identificador,
      Configuracao configuracao) {
    super(identificador, configuracao);
  }

  @Override
  protected Erro obterErroDe(ExecutionException e) {
    return new ErroDeExecucao();
  }

  @Override
  protected Erro obterErroDe(InterruptedException e) {
